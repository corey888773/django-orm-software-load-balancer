...
async def create_todo_item(request: RequestTodoItem):
    ...
    commands_mediator.execute(create_todo_item_command)
...
async def list_todo_items():
    ...
    _books = queries_mediator.execute(list_todo_items_query)
...
async def get_todo_item_by_id(id: int):
    ...
    _book = queries_mediator.execute(get_todo_item_by_id_query)
...
async def delete_todo_item(id: int):
    ...
    commands_mediator.execute(delete_todo_item_command)
...
async def update_todo_item(id: int, request: RequestTodoItem):
    ...
    commands_mediator.execute(update_todo_item_command)
